...
function FreeShippingInline({
  ...
  return (
    <div className="bg-neutral-100 p-2 rounded-none border">
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      ...
      <div className="w-[400px] bg-black text-white p-6 rounded-none ">
        <div className="pb-4">
        ...
        <div className="flex gap-3">
          ...
          <LocalizedClientLink
            className="flex-grow rounded-none bg-terminal-black text-neutral-950 shadow-none outline-none border-[1px] border-white text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
