  ...
  return (
    <div className="py-16 border-b border-terminal-border bg-terminal-black">
      <div className="content-container">
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-6 border-l-2 border-[#6DB3D9] pl-6">
          <div>
            <span className="text-[10px] font-mono font-bold text-[#6DB3D9] uppercase tracking-widest mb-2 block">
