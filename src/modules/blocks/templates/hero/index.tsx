...
export const HeroBlock = (props: HeroBlockProps) => {
  ...
  return (
    <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden bg-businessx-black text-white">
      {bgImage?.url && (
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight text-businessx-white">
          {title}
        </h1>
        {subtitle && (
        ...
        {ctaText && ctaLink && (
          <Link 
            ...
            className={`
              ...
              ${ctaType === 'primary' 
                ? 'bg-businessx-yellow text-terminal-white hover:bg-terminal-black border-2 border-businessx-yellow hover:border-white' 
                : ctaType === 'secondary'
                ? 'bg-terminal-black text-terminal-white hover:bg-businessx-yellow hover:text-terminal-white border-2 border-white hover:border-businessx-yellow'
